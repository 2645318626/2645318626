...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:1px; border-style:solid; border-color:#888888">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" style="position: relative ;top:3px;">
      <tr>
        <td height="60" align="center"><img src="images/icon_order.gif" /></td>
      </tr>
      
      <tr>
        <td align="center">
			<table cellspacing="1" cellpadding="0" width="94%" border="0" bgcolor="#F7F3F7" style="position: relative ;top:3px;">
              <tr height="26">
			...
			<logic:present name="result">
				<logic:iterate id="order" name="result" type="com.itbaizhan.ORM.Orders">
