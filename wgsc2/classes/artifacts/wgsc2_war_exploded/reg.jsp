...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:1px; border-style:solid; border-color:#888888">
  ...
  <tr>
	...
	<html:form action="/mem.do?method=reg" style="margin:0px;" onsubmit="return validateMemberForm(this);">
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF" align="left">
		  <tr>
		  ...
		  <tr bgcolor="#F7F3F7">
			...
			<td height="26"><html:text property="phone" size="30" styleClass="textBox"/><font color="red" size="2">&nbsp;例：13746789045或01075888888</font></td>
		  </tr>
		  <tr bgcolor="#F7F3F7">
		  ...
		  <tr bgcolor="#F7F3F7">
			...
			<td height="26"><html:text property="zip" size="30" styleClass="textBox"/><font color="red" size="2">&nbsp;例：112500</font></td>
		  </tr>
		  <tr bgcolor="#F7F3F7">
			<td width="260" height="26" class="text" align="right"><bean:message key="member.email"/>：</td>
			<td height="26"><html:text property="email" size="30" styleClass="textBox"/><font color="red" size="2">&nbsp;例：1234507965@qq.com</font></td>
		  </tr>
		  <tr>
