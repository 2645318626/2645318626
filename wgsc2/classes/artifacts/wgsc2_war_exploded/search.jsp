...
<%
	...
	String key = "农产品关键字";
	String cateid = "0";
	if (request.getAttribute("key")!=null)key = request.getAttribute("key").toString();
	if (request.getAttribute("cateid")!=null)cateid = request.getAttribute("cateid").toString();
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:1px; border-style:solid; border-color:#888888">
  <tr>
    ...
    <TD height="50" align="right" valign="bottom">
		...
		<INPUT id="qKey" name="qKey" value="<%=key%>" onClick="this.value=''"> 
        <select id="category">
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
		...
		<TABLE width="96%" border=0 align="center" cellPadding=0 cellSpacing=0 class="C_Goods_Title">			
			<TR>
			  <TD><IMG hspace=5 src="images/NewGoods_06.gif"></TD>
			  </TR>
          </TABLE>
          <table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#F7F3F7">
			...
			<logic:notPresent name="merList">
				<tr>
				  <td colspan="4" height="26" class="redText">&nbsp;<bean:message key="mer.search.notExist"/></td>
				</tr>
			</logic:notPresent>
